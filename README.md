...
![]({{site.baseurl}}//bgmap.png)
You can use the [editor on GitHub](https://github.com/avecjini/jekyll/edit/main/README.md) to maintain and preview the content for your website in Markdown files.
